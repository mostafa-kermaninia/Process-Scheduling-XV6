...
_most_invoked_syscall:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  if (get_most_invoked_syscall(pid) < 0) {
  3a:	e8 2c 03 00 00       	call   36b <get_most_invoked_syscall>
...
0000036b <get_most_invoked_syscall>:
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 18 08 00 00 	movzbl 0x818(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 c0 07 00 00 	jmp    *0x7c0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba b8 07 00 00       	mov    $0x7b8,%edx
        while(*s != 0){
...
000005d0 <free>:
 5d0:	55                   	push   %ebp
 5d1:	a1 c4 0a 00 00       	mov    0xac4,%eax
 ...
 611:	5b                   	pop    %ebx
 612:	89 15 c4 0a 00 00    	mov    %edx,0xac4
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 61b:	c3                   	ret    
 ...
 64c:	89 15 c4 0a 00 00    	mov    %edx,0xac4
...
00000660 <malloc>:
 ...
 66c:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 6b1:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 6df:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 70f:	89 15 c4 0a 00 00    	mov    %edx,0xac4
 ...
 71e:	5d                   	pop    %ebp
 71f:	c3                   	ret    
 720:	c7 05 c4 0a 00 00 c8 	movl   $0xac8,0xac4
 727:	0a 00 00 
 72a:	bf c8 0a 00 00       	mov    $0xac8,%edi
 72f:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 736:	0a 00 00 
 739:	89 fa                	mov    %edi,%edx
 73b:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 742:	00 00 00 

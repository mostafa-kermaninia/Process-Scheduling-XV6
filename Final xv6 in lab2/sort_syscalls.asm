...
int main(int argc, char *argv[]) {
  ...
  exit();
  5b:	e8 73 02 00 00       	call   2d3 <exit>
    printf(2, "Error: Could not print system calls for pid %d\n", pid);
  60:	50                   	push   %eax
  61:	53                   	push   %ebx
  62:	68 9c 07 00 00       	push   $0x79c
  67:	6a 02                	push   $0x2
...
00000383 <sort_syscalls>:
 383:	b8 18 00 00 00       	mov    $0x18,%eax
 388:	cd 40                	int    $0x40
 38a:	c3                   	ret    

0000038b <get_most_invoked_syscall>:
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 ec 07 00 00 	jmp    *0x7ec(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba e4 07 00 00       	mov    $0x7e4,%edx
        while(*s != 0){
...
000005f0 <free>:
 5f0:	55                   	push   %ebp
 5f1:	a1 f0 0a 00 00       	mov    0xaf0,%eax
 ...
 631:	5b                   	pop    %ebx
 632:	89 15 f0 0a 00 00    	mov    %edx,0xaf0
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 63b:	c3                   	ret    
 ...
 66c:	89 15 f0 0a 00 00    	mov    %edx,0xaf0
...
00000680 <malloc>:
 ...
 68c:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
 ...
 6d1:	8b 3d f0 0a 00 00    	mov    0xaf0,%edi
 ...
 6ff:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
 ...
 72f:	89 15 f0 0a 00 00    	mov    %edx,0xaf0
 ...
 73e:	5d                   	pop    %ebp
 73f:	c3                   	ret    
 740:	c7 05 f0 0a 00 00 f4 	movl   $0xaf4,0xaf0
 747:	0a 00 00 
 74a:	bf f4 0a 00 00       	mov    $0xaf4,%edi
 74f:	c7 05 f4 0a 00 00 f4 	movl   $0xaf4,0xaf4
 756:	0a 00 00 
 759:	89 fa                	mov    %edi,%edx
 75b:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 762:	00 00 00 

   ...
   a:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  1d:	e8 2e 02 00 00       	call   250 <atoi>
    asm volatile(
  22:	89 db                	mov    %ebx,%ebx
  24:	89 c3                	mov    %eax,%ebx
    create_palindrome();
  26:	e8 38 03 00 00       	call   363 <create_palindrome>
    asm volatile("movl %0, %%ebx" : : "r"(perv_val));
  ...
  32:	50                   	push   %eax
  33:	50                   	push   %eax
  34:	68 68 07 00 00       	push   $0x768
  39:	6a 01                	push   $0x1
  3b:	e8 00 04 00 00       	call   440 <printf>
        exit();
  40:	e8 7e 02 00 00       	call   2c3 <exit>
  45:	66 90                	xchg   %ax,%ax
  47:	66 90                	xchg   %ax,%ax
  49:	66 90                	xchg   %ax,%ax
  4b:	66 90                	xchg   %ax,%ax
...
00000050 <create_palindrome1>:
{
  ...
  5c:	89 db                	mov    %ebx,%ebx
    create_palindrome();
  5e:	e8 00 03 00 00       	call   363 <create_palindrome>
    asm volatile("movl %0, %%ebx" : : "r"(perv_val));
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 88 07 00 00 	jmp    *0x788(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 81 07 00 00       	mov    $0x781,%edx
        while(*s != 0){

...
int main(int argc, char *argv[]) {
  ...
  34:	e8 32 03 00 00       	call   36b <move_file>
  39:	83 c4 10             	add    $0x10,%esp
  3c:	85 c0                	test   %eax,%eax
  3e:	78 16                	js     56 <main+0x56>
    printf(2, "move_file failed\n");
  } else {
    printf(1, "File moved successfully\n");
  40:	50                   	push   %eax
  41:	50                   	push   %eax
  42:	68 ac 07 00 00       	push   $0x7ac
  47:	6a 01                	push   $0x1
  ...
  56:	52                   	push   %edx
  57:	52                   	push   %edx
  58:	68 9a 07 00 00       	push   $0x79a
  5d:	6a 02                	push   $0x2
  5f:	e8 dc 03 00 00       	call   440 <printf>
  64:	83 c4 10             	add    $0x10,%esp
  67:	eb e8                	jmp    51 <main+0x51>
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
0000037b <get_most_invoked_syscall>:
 37b:	b8 19 00 00 00       	mov    $0x19,%eax
 380:	cd 40                	int    $0x40
 382:	c3                   	ret    

00000383 <list_all_processes>:
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 24 08 00 00 	movzbl 0x824(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 cc 07 00 00 	jmp    *0x7cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba c5 07 00 00       	mov    $0x7c5,%edx
        while(*s != 0){
...
000005e0 <free>:
 5e0:	55                   	push   %ebp
 5e1:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 621:	5b                   	pop    %ebx
 622:	89 15 cc 0a 00 00    	mov    %edx,0xacc
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 62b:	c3                   	ret    
 ...
 65c:	89 15 cc 0a 00 00    	mov    %edx,0xacc
...
00000670 <malloc>:
 ...
 67c:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 6c1:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 6ef:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
 ...
 71f:	89 15 cc 0a 00 00    	mov    %edx,0xacc
 ...
 72e:	5d                   	pop    %ebp
 72f:	c3                   	ret    
 730:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 737:	0a 00 00 
 73a:	bf d0 0a 00 00       	mov    $0xad0,%edi
 73f:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 746:	0a 00 00 
 749:	89 fa                	mov    %edi,%edx
 74b:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 752:	00 00 00 
